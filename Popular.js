...
export default function Popular() {
  ...
  return (
    <div>
    <h1 className='head18'>Popular Movies</h1>
    <div className='slide1'>
      ...
      <div className='slide-items'>
        ...
        <img className='slides'onClick={()=>{handleOpen();singleview(pop?.id)}} src={`https://image.tmdb.org/t/p/original${pop.poster_path}`} alt=''></img>
        </div>
        </>
         ))}
      </div>
