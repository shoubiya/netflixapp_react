...
export default function Trending() {
  ...
  useEffect(()=>{
    axios.get(`https://api.themoviedb.org/3/trending/all/day?api_key=6cdf1bc39c14d06f4b51e70d622928f4`).then(response=>{
  ...
  return (
    <div>
    <h1 className='head12'>Trending Movies</h1>
    <div className='slide1'>
      ...
      <div className='slide-items'>
        ...
        <img className='slides' onClick={()=>{handleOpen();singleview(trend?.id)}} src={`https://image.tmdb.org/t/p/original${trend?.poster_path}`} alt=''></img>
        </div>
        </>
         ))}
      </div>
